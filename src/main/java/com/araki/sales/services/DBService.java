...
import com.araki.sales.model.Pagamento;
...
import com.araki.sales.repositories.CidadeRepository;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Produto p1 = new Produto(null, "Computador", 2430.00);
		Produto p2 = new Produto(null, "Impressora", 545.00);
		Produto p3 = new Produto(null, "Mouse", 80.00);
		Produto p4 = new Produto(null, "Mesa de Escritório", 300.00);
		Produto p5 = new Produto(null, "Toalha", 50.00);
		Produto p6 = new Produto(null, "Colcha", 200.00);
		Produto p7 = new Produto(null, "TV Full HD", 1299.00);
		Produto p8 = new Produto(null, "Roçadeira", 800.00);
		Produto p9 = new Produto(null, "Abajour", 89.99);
		Produto p10 = new Produto(null, "Pendente", 179.99);
		Produto p11 = new Produto(null, "Shampoo", 29.05);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "luisaraki@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, passwordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));

		Cliente cli2 = new Cliente(null, "Ana Clara", "luis.araki@gmail.com", "60812331036", TipoCliente.PESSOAFISICA, passwordEncoder.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("33364423","97835592"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Rua Campos", "077", null, "Vila Maria", "12310505", cli2, c2);
